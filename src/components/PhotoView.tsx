...
export default function PhotoView({ sessions, onSelectSession }: PhotoViewProps) {
  ...
  return (
    <div ref={scrollRef} onScroll={handleScroll} className="flex-1 h-full bg-white overflow-y-auto pb-16 md:pb-0 custom-scrollbar">
      {/* Header */}
      <div className="bg-sidebar-bg pattern-grid border-b border-list-border px-6 md:px-12 py-8 md:py-10 sticky top-0 z-10">
        <h2 className="text-xl md:text-2xl font-handwriting text-sidebar-text-active">Gallery</h2>
