                  ...
                  return (
                    <div className={cn(
                      ...
                      {nonImageParts && hasNonImageContent ? (
                          ...
                          {nonImageParts.map((part, idx) => (
                            <div key={idx} className="w-full max-w-full min-w-0">
                              {part.type === 'text' && part.content.trim() !== '' && (
                                <div className={cn("markdown-body leading-relaxed text-[15px] break-words min-w-0", msg.role === 'user' ? "text-bubble-user-text" : "text-slate-800")}>
                        ...
                        <div className={cn(
                          "markdown-body leading-relaxed text-[15px] max-w-full min-w-0 break-words",
